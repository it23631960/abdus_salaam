jQuery(document).ready(function($) {
    'use strict';
    var this_obj = professional_portfolio_plugin_activate_plugin;

    $(document).on('click', '.professional-portfolio-plugin-install', function(event) {
        ...
        wp.updates.installPlugin({
            ...
            success: function(data) {
                ...
                button.removeClass('button-secondary updating-message professional-portfolio-plugin-install');
                button.addClass('button-primary professional-portfolio-plugin-activate');
                button.trigger('click');
            },
            error: function(data) {
                jQuery('.professional-portfolio-recommended-plugins .professional-portfolio-activation-note').css('display','block');
    ...
    $(document).on('click', '.professional-portfolio-plugin-activate', function(event) {
    ...
    jQuery('#lite_theme .ibtana-skip-btn').click(function(){
        ...
        jQuery('#lite_theme .professional-portfolio-recommended-plugins').css('display','none');
    });

    jQuery('#block_pattern .ibtana-skip-btn').click(function(){
        var light_theme = jQuery(this).attr('get-start-tab-id');
        jQuery('.' + light_theme).css('display','block');
        jQuery('#block_pattern .professional-portfolio-recommended-plugins').css('display','none');
    });
