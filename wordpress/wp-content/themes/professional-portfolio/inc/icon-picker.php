...
class Professional_Portfolio_Fontawesome_Icon_Chooser extends WP_Customize_Control{
    public $type = 'icon';
        ...
        ?>
            <label>
                ...
                <div class="social-icon-search">
                    <input class="socialInput" type="text" placeholder="<?php echo esc_attr_x( 'Icon', 'placeholder', 'professional-portfolio' ); ?>">
                </div>
                ...
                <ul class="icon-list clearfix">
                    <?php
                    $professional_portfolio_font_awesome_icon_array = professional_portfolio_font_awesome_icon_array();
                    foreach ($professional_portfolio_font_awesome_icon_array as $professional_portfolio_font_awesome_icon) {
                            $icon_class = $this->value() == $professional_portfolio_font_awesome_icon ? 'icon-active' : '';
                            echo '<li class='.esc_attr($icon_class).'><i class="'.esc_attr($professional_portfolio_font_awesome_icon).'"></i>
                            <span class="professional-portfolio-social-class">'.esc_attr($professional_portfolio_font_awesome_icon).'</span>
                            </li>';
                        }
                    ?>
                </ul>
...
function professional_portfolio_customizer_script() {
     
    wp_enqueue_style( 'font-awesome-1', esc_url(get_template_directory_uri()).'/assets/css/fontawesome-all.css');
    wp_enqueue_script( 'professional-portfolio-customizer-script', esc_url(get_template_directory_uri()).'/assets/js/customizer-scripts.js', array("jquery"),'', true  );
}
add_action( 'customize_controls_enqueue_scripts', 'professional_portfolio_customizer_script' );

if(!function_exists('professional_portfolio_font_awesome_icon_array')){
    function professional_portfolio_font_awesome_icon_array(){
